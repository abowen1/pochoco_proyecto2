...
module pochoco_soc #(
  ...
  wire clk;
  // The board oscillator is 25 MHz. The complete SoC runs at 3.125 MHz.
  // A single divided clock drives CPU, RAM, counter and peripherals.
  reg [2:0] clock_divider = 0;
  always @(posedge i_Clk) clock_divider <= clock_divider + 1'b1;
